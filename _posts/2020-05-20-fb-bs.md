...
In summary, we did a quick demonstration of how to download your data from Facebook, use BeautifulSoup to parse it, and create a wordcloud. Scraping can be expanded to many applications in business and industry problems e.g. for data augmentation in competion and market research. Stay tuned for more tutorials on web scraoing, next would be scraping from 
