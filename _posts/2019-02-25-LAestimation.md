...
{:refdef: style="text-align: center;"}
<img src="{{ site.url }}{{ site.baseurl }}/images/Image1_LA.png" alt="Generated Synthetic Shapes" class="center">
{: refdef}
...
{:refdef: style="text-align: center;"}
<img src="{{ site.url }}{{ site.baseurl }}/images/Image4_LA.png" alt="Extracted Image in Paint" class="center">
{: refdef}
