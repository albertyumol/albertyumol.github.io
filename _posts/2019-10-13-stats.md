...
We read this equation as the probability of the event $$B$$ will occur given the knowledge that event $$A$$ has already occurred. Or simply: probability of $$B$$ given $$A$$.
