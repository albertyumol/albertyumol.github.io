...
<h2>Dependence and Independence</h2>

Consider two events $$A$$ and $$B$$. When knowing whether $$A$$ happens gives us information if $$B$$ happens, we say that $$A$$ and $$B$$ are *dependent*.

On the contrary, if knowing event $$A$$ adds no information if $$B$$ occurs, we say that $$A$$ and $$B$$ are *independent*.
