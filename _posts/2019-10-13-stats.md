...
This is a draft for a basic statistics module for data scientists developed for **Eskwelabs**. The module assumes that the reader knows some basic Pythons and survival algebra.
...
In the recent decade, we have produced majority of our data due to increased in computing powers of our machines, increase in volume of our storage systems and the decrease in the cost of technology. These led to the accessibility of technology to a lot more people.
