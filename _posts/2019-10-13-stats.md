...
A better alternative to hypothesis testing is the doing a Bayesian Inference procedure by interpreting probabilities not from the test but from the parameters themselves.
