...
Let $$d$$ me the variable for the disease and $$p$$ for postive. If we want to know if you have the disease given that you tested positive,
...
Assuming that the people took the test at random.
