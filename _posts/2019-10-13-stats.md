...
<small>
**Outline** <br>
(1) Measures of Central Tendencies <br>
(2) Measures of Dispersion <br>
(3) Correlation and Causation <br>
(4) Probability <br>
<emsp>(a) Dependence and Independence <br>
<emsp>(b) Conditional Probability <br>
<emsp>(c) Baye's Theorem <br>
<emsp>(d) Random Variables <br>
<emsp>(e) Continuous distributions <br>
<emsp>(f) Normal distribution <br>
<emsp>(g) Central Limit Theorem <br>
(5) Hypothesis and interference <br>
<emsp>(a) Confidence interval <br>
<emsp>(b) Bayesian inference <br>
</small>
</blockquote>
