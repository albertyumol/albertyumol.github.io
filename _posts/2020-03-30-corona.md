...
This is more evident when we look at the population pyramid of the Philippines.

{:refdef: style="text-align: center;"}
<img src="{{ site.url }}{{ site.baseurl }}/images/eda_corona/pyramid_PH.png" alt="pyramid" class="center">
{: refdef}

Another interesting parameter to look at is gender.

{:refdef: style="text-align: center;"}
<img src="{{ site.url }}{{ site.baseurl }}/images/eda_corona/gender.png" alt="gender" class="center">
{: refdef}
...
It's easier to interpret if we combine the visualize the gender and age group.
